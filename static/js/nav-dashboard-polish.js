(function () {
  function polishDashboardTiles() {
    ...
    if (routinesTile) {
      ...
      if (desc) desc.textContent = 'Routine setup, editing, cards, and day view.';
      if (actions) {
        actions.innerHTML = '<a href="/routines" class="btn btn-sm btn-primary">Manage</a>' +
          '<a href="/cards" class="btn btn-sm btn-secondary">Cards</a>';
      }
    }
  }
