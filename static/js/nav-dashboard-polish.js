  ...
  function injectRoutinePolishStyles() {
    ...
    style.textContent = `
      @media (max-width: 840px) {
        .main-content { padding-left: .45rem !important; padding-right: .45rem !important; }
        #dynamic-routine-app { margin-left: -.15rem; margin-right: -.15rem; }
        .eff-columns {
          grid-template-columns: minmax(190px, .92fr) minmax(228px, 1.22fr) !important;
          gap: .48rem !important;
          overflow-x: auto;
        ...
        .eff-column { min-width: 190px; scroll-snap-align: start; gap: .55rem !important; }
        .eff-flex-column { min-width: 228px; }
        .eff-column-title, .eff-section { padding: .62rem !important; }
        .eff-task { gap: .45rem !important; padding: .58rem .5rem !important; border-radius: .72rem !important; }
        .eff-check { flex-basis: 1.34rem !important; width: 1.34rem !important; height: 1.34rem !important; font-size: .78rem !important; }
        .eff-task strong { font-size: .8rem !important; line-height: 1.1; }
        .eff-task small { font-size: .64rem !important; line-height: 1.15; }
        .eff-hero { padding: .75rem !important; }
        .eff-summary { gap: .34rem !important; }
        .eff-summary span { padding: .28rem .5rem !important; font-size: .74rem !important; }
      }
    ...
    body.innerHTML = '<div class="lm-edit-sheet" role="dialog" aria-modal="true">' +
      ...
      '<div class="lm-edit-grid">' +
        (info.isDaily
          ...
          : '<label>Manual next due date<input id="lm-edit-due" type="date" value="' + currentDue + '"></label><p style="margin:0;color:var(--text-muted);font-size:.72rem;">This adjusts the view. Completing the task still refreshes the recurring due-date side.</p>') +
      '</div>' +
